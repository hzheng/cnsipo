...
def test_applicant2():
    applicant_types = [
        ("中国石油天然气股份有限公司兰州石化分公司", "兰州",
            [(I, '甘肃', '中国石油天然气股份有限公司兰州石化分公司',
                '中国石油天然气股份有限公司')]),
        ("中国科学院化学研究所", "100084中科院",
            [(G, '北京', '中国科学院化学研究所', '中国科学院')]),
        # trap: 东丽 is a district of Tianjin
        ("中国科学院成都生物研究所; 东丽株式会社",
         "610041四川省成都市人民南路四段九号",
            [(G, '四川', '中国科学院成都生物研究所', '中国科学院'),
             (I, F, '东丽株式会社', '东丽株式会社')]),
        # test parentheses
        ("中国石油（化学）研究所", "100084",
            [(G, '北京', '中国石油(化学)研究所', '中国石油(化学)研究所')]),
        ("中国医学科学院肿瘤医院肿瘤研究所", "100084中科院",
            [(G, '北京', '中国医学科学院肿瘤医院肿瘤研究所', '中国医学科学院')]),
